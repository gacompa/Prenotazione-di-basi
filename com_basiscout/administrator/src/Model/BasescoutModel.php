...
namespace Scoutcodera\Component\Basiscout\Administrator\Model;
// No direct access.
 ...
 * @since  1.0.0
 */
class BasescoutModel extends AdminModel
{
	/**
	 ...
	 * @since  1.0.0
	 */
	protected $text_prefix = 'COM_BASISCOUT';
	 ...
	 * @since  1.0.0
	 */
	public $typeAlias = 'com_basiscout.basescout';
	...
	/**
	 * Method to duplicate an Basescout
	 *
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_basiscout'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = Factory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__basiscout');
				$max             = $db->loadResult();
